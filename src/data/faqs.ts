...
export const PAGE_FAQS: FAQ[] = [
  {
    ...
    answer: 'We aim to respond to <a href="/services/emergency-drain-services/" class="text-primary hover:underline">emergency drainage callouts</a> within 60-90 minutes across <a href="/locations/burton-upon-trent/" class="text-primary hover:underline">Burton upon Trent</a> and Staffordshire. Our team operates around the clock, so help is available whenever you need it, day or night.'
  },
  {
    question: "Do you charge a call-out fee?",
  ...
  },
  {
    ...
    answer: 'We provide drainage services throughout <a href="/locations/burton-upon-trent/" class="text-primary hover:underline">Burton upon Trent</a> and Staffordshire, including <a href="/locations/uttoxeter/" class="text-primary hover:underline">Uttoxeter</a>, <a href="/locations/swadlincote/" class="text-primary hover:underline">Swadlincote</a>, <a href="/locations/lichfield/" class="text-primary hover:underline">Lichfield</a>, Tamworth, Derby, Ashby-de-la-Zouch, Rugeley, and Tutbury. See <a href="/locations/" class="text-primary hover:underline">all locations we cover</a>.'
  },
  {
